...
namespace Ticketing.API.Proxies
{
    ...
    partial class AutoGeneratedIFileProxy : IFileProxy
    {
        ...
        /// <inheritdoc />
        Task<byte[]> IFileProxy.Get(string authorization, int id)
        {
            var arguments = new object[] { authorization, id };
            var func = requestBuilder.BuildRestResultFuncForMethod("Get", new Type[] { typeof(string), typeof(int) });
        ...
        /// <inheritdoc />
        Task<byte[]> IFileProxy.GetFace(string authorization, int staffId)
        {
            var arguments = new object[] { authorization, staffId };
            var func = requestBuilder.BuildRestResultFuncForMethod("GetFace", new Type[] { typeof(string), typeof(int) });
            return (Task<byte[]>)func(Client, arguments);
        }

        /// <inheritdoc />
        Task<byte[]> IFileProxy.GetVoice(string authorization, int staffId)
        {
            var arguments = new object[] { authorization, staffId };
            var func = requestBuilder.BuildRestResultFuncForMethod("GetVoice", new Type[] { typeof(string), typeof(int) });
            return (Task<byte[]>)func(Client, arguments);
        }

        /// <inheritdoc />
        Task IFileProxy.Upload(string authorization, FileUploadParameters parameters)
        {
            var arguments = new object[] { authorization, parameters };
            var func = requestBuilder.BuildRestResultFuncForMethod("Upload", new Type[] { typeof(string), typeof(FileUploadParameters) });
...
namespace Ticketing.API.Proxies
{
    ...
    partial class AutoGeneratedIProductProxy : IProductProxy
    {
        ...
        /// <inheritdoc />
        Task<List<ProductViewResult>> IProductProxy.Get(string authorization)
        {
            var arguments = new object[] { authorization };
            var func = requestBuilder.BuildRestResultFuncForMethod("Get", new Type[] { typeof(string) });
...
namespace Ticketing.API.Proxies
{
    ...
    partial class AutoGeneratedIReplyProxy : IReplyProxy
    {
        ...
        /// <inheritdoc />
        Task<List<ReplyViewResult>> IReplyProxy.Get(string authorization, ReplySearchParameters parameters)
        {
            var arguments = new object[] { authorization, parameters };
            var func = requestBuilder.BuildRestResultFuncForMethod("Get", new Type[] { typeof(string), typeof(ReplySearchParameters) });
            return (Task<List<ReplyViewResult>>)func(Client, arguments);
        }

        /// <inheritdoc />
        Task<ReplyCreateResult> IReplyProxy.Create(string authorization, ReplyCreateParameters parameters)
        {
            var arguments = new object[] { authorization, parameters };
            var func = requestBuilder.BuildRestResultFuncForMethod("Create", new Type[] { typeof(string), typeof(ReplyCreateParameters) });
...
namespace Ticketing.API.Proxies
{
    ...
    partial class AutoGeneratedIStaffMemberProxy : IStaffMemberProxy
    {
        ...
        /// <inheritdoc />
        Task<StaffMemberViewResult> IStaffMemberProxy.Get(string authorization, int id)
        {
            var arguments = new object[] { authorization, id };
            var func = requestBuilder.BuildRestResultFuncForMethod("Get", new Type[] { typeof(string), typeof(int) });
        ...
        /// <inheritdoc />
        Task<StaffMemberUpdateResult> IStaffMemberProxy.Update(string authorization, int id, StaffMemberCreateParameters parameters)
        {
            var arguments = new object[] { authorization, id, parameters };
            var func = requestBuilder.BuildRestResultFuncForMethod("Update", new Type[] { typeof(string), typeof(int), typeof(StaffMemberCreateParameters) });
...
namespace Ticketing.API.Proxies
{
    ...
    partial class AutoGeneratedITicketProxy : ITicketProxy
    {
        ...
        /// <inheritdoc />
        Task<List<TicketViewResult>> ITicketProxy.Get(string authorization)
        {
            var arguments = new object[] { authorization };
            var func = requestBuilder.BuildRestResultFuncForMethod("Get", new Type[] { typeof(string) });
        ...
        /// <inheritdoc />
        Task<List<TicketViewResult>> ITicketProxy.Get(string authorization, TicketSearchParameters parameters)
        {
            var arguments = new object[] { authorization, parameters };
            var func = requestBuilder.BuildRestResultFuncForMethod("Get", new Type[] { typeof(string), typeof(TicketSearchParameters) });
            return (Task<List<TicketViewResult>>)func(Client, arguments);
        }

        /// <inheritdoc />
        Task<TicketViewResult> ITicketProxy.Get(string authorization, int id)
        {
            var arguments = new object[] { authorization, id };
            var func = requestBuilder.BuildRestResultFuncForMethod("Get", new Type[] { typeof(string), typeof(int) });
